...
public class UserRegisterValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		if (!u.getEmail().equals(null)) {
			boolean isMatch = AppdemoUtils.checkEmailOrPassword(AdozlConstants.emailPattern, u.getEmail());
			if(!isMatch) {
		...
		if (!u.getPassword().equals(null)) {
			boolean isMatch = AppdemoUtils.checkEmailOrPassword(AdozlConstants.passwordPattern, u.getPassword());
			if(!isMatch) {
