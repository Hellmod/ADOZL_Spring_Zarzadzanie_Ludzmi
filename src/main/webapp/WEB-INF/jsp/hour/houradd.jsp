                ...
                <div class="col-sm-6 offset-sm-3">
                    <sf:form id="hourForm" action="inserthour" modelAttribute="hour" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="hour_from_string" type="text" class="form-control" id="hour_from_string" placeholder="<s:message code="hour.hour_from"/>"">
                        ...
                        <div class="form-group">
                            ...
                            <input name="hour_to_string" type="text" class="form-control" id="hour_to_string" placeholder="<s:message code="hour.hour_to"/>">
